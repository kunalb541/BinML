...
detectable anomalies in the natural tier and 27% fewer in the wide-separation sweep's quoted first four shards (64
against 88 expected from the suite's rate; 32% fewer, 296 against 438, over all 20 of its shards regenerated with the
July generator by the fifth verification, not archived); the other tiers' label fractions agree with the suite's within
|z| < 2.5 (checked in make_macros.py; the two deficits are z = -2.9 and -2.5). Stage 5 gives the suite's macro-F1 on the subset (0.927 vs 0.927) and differs from its other quoted
...
demoted binaries of natural timescale in the regenerated tier (42% over all 20 shards regenerated by the fifth
