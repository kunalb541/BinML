...
| G14 | major | finite-source gain confounded with 12 extra epochs and a different pool; round-2 penalty understated | Confound confirmed and separated: the point-source control (pspl5s_ctrl, same pool shape, recipe and warm start) gives FA 6.4% and recall 0.361 at 5.2% (g08e12 11.6% / 0.295; fspl5s 4.8% / 0.390), so the extra training explains most of the gain and the physics the rest, concentrated in the two largest rho/|u0| bins (0.41 / 0.51 -> 0.28 / 0.29); only the physics restores large-source single-lens recall on our own held-out (0.22 / 0.16 -> 0.66 / 0.84). Round-2 penalty quantified (FA 8.7% vs 4.8%). | numbers-draft-15, training-experiments-11, referee-logic-15 |
