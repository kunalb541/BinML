...
Real-time cascade (event-level first threshold crossing, n=1000): detects 89% within the season, median alert 1.3 d after onset, premature for 31.3% of eligible binaries (95% CI 28.5-34.2%); grid-dependent lower bound. The legacy 42%->9% figure was untracked and is withdrawn. Generalises
