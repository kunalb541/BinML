...
Real-time cascade (event-level, first threshold crossing, n=200): detects 89% within the season, median alert 1.8 d after onset, premature for 26% of eligible binaries (CI 20-32%); grid-dependent lower bound. The legacy 42%->9% figure was untracked and is withdrawn. Generalises
