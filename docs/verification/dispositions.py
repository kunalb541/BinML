...
ISSUES = {
 ...
 "G44": ("RMDC26 described as a pure test set", "Disclosed: it guided the diagnosis, the single-lens rho prior and the choice among the fine-tuned checkpoints scored on it (14 by 2026-09-12; the first version of this disposition said seven and the draft macro counted 8-9, second pass H05); numbers for the chosen checkpoint are optimistic."),
