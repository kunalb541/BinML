...
| Decision: gap-aware checkpoint = `ft_fspl5s_g08.pt` at 0.957 (`gapped_threshold_fspl5s_g08_seasons.json`) | **Recommended** (combined arm tied at matched budgets; smooth-magnification control §1½ row 14) — author confirms at release, as `binml-gapaware.pt` | draft only |
