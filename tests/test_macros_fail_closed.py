...
CASES = {
    ...
    "periodic labels worse than long-period": (lambda t: _edit(t, "../truth_relabel_impact.json",
                                                               lambda d: d["results"]["truncation"]["disagree_k_by_class"].update(PeriodicVar=2000)),
                                               "long-period variables no longer have the largest"),
